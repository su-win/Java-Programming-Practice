...
public class Exercise15_30 extends Application{
	...
	public void start(Stage primaryStage) {
		...
		//animation for alternating slides
		...
		//When user click, get the animation status and if the animation is pause, resume the animation.
		//If the animation is play, pause the animation.
